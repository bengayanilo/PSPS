        ...
        <div style="padding:10px">
            ...
            <div class="space">
                ...
                <div>
                    ...
                    <?php
                        foreach($db->query('SELECT * FROM tbl_users WHERE user_type="psy" ORDER BY user_name') as $item) {
                            $selected = "";
                            if ($event["user_id"] == $item["user_id"]) {
                                $selected = " selected";
                            }
                            echo "<option value='".$item["user_id"]."'".$selected.">".$item["user_name"]."</option>";
                        }
                    ?>
                    </select>
                </div>
